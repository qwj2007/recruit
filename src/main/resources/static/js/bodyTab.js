        ...
        for(var i=0;i<data.length;i++){
            ...
            if(data[i].children !== undefined && data[i].children.length > 0){
                ...
                for(var j=0;j<data[i].children.length;j++){
                	var lurl=url+"/"+data[i].children[j].item.linkUrl;
                    if (data[i].children[j].item.target === "_blank"){
                        ulHtml += '<dd><a data-url="' + lurl + '" target="' + data[i].children[j].item.target+'">';
                    }else{
                        ulHtml += '<dd><a data-url="' + lurl+'">';
                    }
                ...
                var lurl=url+"/"+data[i].Item.linkUrl;
                if(data[i].item.target === "_blank"){
                    ulHtml += '<a data-url="' + lurl + '" target="' + data[i].item.Target+'">';
                }else{
                    ulHtml += '<a data-url="' +lurl+'">';
                }
                if(data[i].item.iconUrl !== undefined && data[i].item.iconUrl !== ''){
                    if(data[i].item.iconUrl.indexOf("icon-") !== -1){
                        ulHtml += '<i class="seraph '+data[i].item.iconUrl+'" data-icon="'+data[i].item.iconUrl+'"></i>';
